...
@section('content')
<h2 class="ml-5">EDIT PRODUCT {{  $product->id }}</h2>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group row ml-2">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" placeholder="Nhập tên sản phẩm" value="{{ $product->product_name }}">
                    @if ($errors->has('name'))
            ...
            <div class="form-group row ml-2">
                ...
                <div class="col-sm-9">
                    <input type="number" step="0.01" class="form-control @error('price') is-invalid @enderror" id="price" name="price" placeholder="Nhập giá bán" value="{{ $product->product_price }}">
                    @if ($errors->has('price'))
            ...
            <div class="form-group row ml-2">
                ...
                <div class="col-sm-9">
                    <textarea class="form-control" id="description" name="description" rows="5" placeholder="Nhập mô tả sản phẩm">{{ $product->description }}</textarea>
                </div>
            </div>
            ...
            <div class="form-group row ml-2">
                ...
                <div class="col-sm-9">
                    <select class="form-control @error('state') is-invalid @enderror" name="state" id="state" value="{{ $product->is_sales }}">
        ...
        <div class="col-md-6">
            ...
            <div class="temp-img"><img src="{{ $product->product_image }}" style="height: 200px; width:300px;" class="rounded mt-3 ml-5"></div>
